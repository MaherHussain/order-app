...
export default function Register() {
  return (
    <div className="pt-5 flex justify-center flex-col">
      <h2 className="text-xl text-primary py-2 text-center">Register</h2>
      <Form />
      <hr className="my-5" />
      <div className="flex items-center justify-center dark:bg-gray-700 mt-5">
      ...
      {/* <div className="google-register flex justify-center flex-col mt-5">
        <p className="text-gray-500 mb-5 text-center">Or</p>
        <a className="flex justify-center  w-1/2 border border-gray-300 rounded">
          <Image
            src={googleLogo}
            width={50}
            height={50}
